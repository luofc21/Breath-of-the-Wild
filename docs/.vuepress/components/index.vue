<template>
  <div class="index-wrap">
    <div
      :style="{'background-image':`url(http://luofch.gitee.io/image_server/images/header-bg.jpg)`}"
      class="banner-wrap"
    >
      ...
      <aside>
        <div class="card-wrap card-info">
          ...
          <div class="social-info">
            <a href="https://github.com/luo-FC">
            ...
            <i @click="openMail" class="shni shn-mail-fill"></i>
            <!-- <a href="mailto:luofc0180@163.com">
        ...
        <div class="card-wrap card-carousel">
          <el-carousel :interval="10000" arrow="always" direction="horizontal" trigger="click">
...
export default {
  data() {
    return {
      ...
      carouselInfo: [
        // {
        //   title: '日记',
        //   content: '努力生活，生活肯定是有趣的',
        //   bg: 'https://cdn.chenyingshuang.cn/index/carousel1.jpg'
        // },
        {
          title: '旅行',
          content:
            '远方永远令人向往，去吧，奔向祖国的大好河山',
          bg: 'https://cmall-luofc.oss-cn-shenzhen.aliyuncs.com/myblog/v1230w.jpg'
        },
        {
          title: '学习',
  ...
  methods: {
    ...
    //     message:
    //       '<img src="https://cdn.chenyingshuang.cn/index/al.jpg" style="width:200px"/>',
    //     duration: 0,
